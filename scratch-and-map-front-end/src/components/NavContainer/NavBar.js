...
// { onToggle, visible, onPusherClick, refreshMap }
const NavBar = props => (
  <div>
    <Sidebar.Pushable>
      <Sidebar
      ...
      >
        <Button.Group className="closebutton">
          <Button onClick={props.onToggle} icon="close" inverted />
        </Button.Group>
        <Menu.Item as="a" as={Link} to="/">
          <img src={logo} onClick={() => props.refreshMap()} />
        </Menu.Item>
        ...
        <SidebarDrop />
        <FriendListView visible={props.visible} />
      </Sidebar>
      <div className="Menu">
        <div className="MenuButton">
          <Button className="navbutton" inverted onClick={props.onToggle}>
            Menu
          </Button>
        </div>
        ...
        trigger={
          <Button color="black" inverted size="tiny" compact>
            <div className="contact">
              <img src={logo} style={{ height: "30px", margin: "5px" }} />
              <p>DEV TEAM</p>
            </div>
          </Button>
        }
        ...
        <Header
          content={
            <div style={{ display: "flex" }}>
              <img src={logo} style={{ height: "50px", margin: "5px" }} />
              <p style={{ fontSize: "30px", marginTop: "13px" }}>DEV TEAM</p>
            </div>
          }
        />
        <Modal.Content>
